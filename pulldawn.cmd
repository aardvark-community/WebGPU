...
cmake ..\.. -G "Visual Studio 17 2022" -A x64 -DDAWN_BUILD_MONOLITHIC_LIBRARY=SHARED -DCMAKE_CXX_STANDARD=17 -DDAWN_BUILD_TESTS=OFF -DTINT_BUILD_TESTS=OFF -DTINT_BUILD_CMD_TOOLS=OFF -DCMAKE_BUILD_TYPE=Release -DTINT_BUILD_SPV_READER=1 -DTINT_BUILD_WGSL_WRITER=1
