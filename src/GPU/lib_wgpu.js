#if parseInt(EMSCRIPTEN_VERSION.split('.')[0]) < 3 || (parseInt(EMSCRIPTEN_VERSION.split('.')[0]) == 3 && parseInt(EMSCRIPTEN_VERSION.split('.')[1]) < 1) || (parseInt(EMSCRIPTEN_VERSION.split('.')[0]) == 3 && parseInt(EMSCRIPTEN_VERSION.split('.')[1]) == 1 && parseInt(EMSCRIPTEN_VERSION.split('.')[2]) < 34)
// Emscripten 3.1.35 or newer is needed because of https://github.com/emscripten-core/emscripten/issues/19469
#error "wasm_webgpu requires building with Emscripten 3.1.34 or newer. Please update"
#endif
...
let api = {
  ...
  $wgpuStoreAndSetParent: function(object, parent) {
    if (object) {
      ...
      {{{ wassert('Object.keys(parent.derivedObjects).length < Object.keys(wgpu).length'); }}}
      return objectId;
    }
  },
...
//////////////////////////////////////////////////////////////////
  ...
  wgpuReportErrorCodeAndMessage__deps: [
  ...
  wgpu_device_pop_error_scope_sync__deps: ['$wgpu_async', 'wgpuMuteJsExceptions', 'wgpuErrorObjectToErrorType'],
//  wgpu_device_pop_error_scope_sync__sig: 'iipi', // Iirc this would be needed for -sASYNCIFY=1 build mode, but this breaks -sMEMORY64=1 due to the detrimental automatic wrappers
  ...
  wgpu_shader_module_get_compilation_info_async__deps: ['malloc'],
...
//ibraryManager.library['$wgpu'] = api;
