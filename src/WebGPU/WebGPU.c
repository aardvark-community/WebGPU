...
EMSCRIPTEN_KEEPALIVE void* gpuGetProcAddress(WGPUStringView procName) {
    return wgpuGetProcAddress(procName);
}
EMSCRIPTEN_KEEPALIVE WGPUInstance gpuAdapterGetInstance(WGPUAdapter self) {
    return wgpuAdapterGetInstance(self);
}
EMSCRIPTEN_KEEPALIVE int gpuAdapterGetLimits(WGPUAdapter self, WGPUSupportedLimits* limits) {
    return wgpuAdapterGetLimits(self, limits);
}
EMSCRIPTEN_KEEPALIVE int gpuAdapterGetInfo(WGPUAdapter self, WGPUAdapterInfo* info) {
...
EMSCRIPTEN_KEEPALIVE int gpuAdapterGetFormatCapabilities(WGPUAdapter self, int format, WGPUFormatCapabilities* capabilities) {
...
EMSCRIPTEN_KEEPALIVE WGPUFuture gpuBufferMapAsyncF(WGPUBuffer self, int mode, size_t offset, size_t size, WGPUBufferMapCallbackInfo callbackInfo) {
    return wgpuBufferMapAsyncF(self, mode, offset, size, callbackInfo);
}
EMSCRIPTEN_KEEPALIVE WGPUFuture gpuBufferMapAsync2(WGPUBuffer self, int mode, size_t offset, size_t size, WGPUBufferMapCallbackInfo2 callbackInfo) {
...
EMSCRIPTEN_KEEPALIVE void gpuCommandEncoderInjectValidationError(WGPUCommandEncoder self, WGPUStringView message) {
...
EMSCRIPTEN_KEEPALIVE WGPUShaderModule gpuDeviceCreateErrorShaderModule(WGPUDevice self, const WGPUShaderModuleDescriptor* descriptor, WGPUStringView errorMessage) {
...
EMSCRIPTEN_KEEPALIVE WGPUSharedBufferMemory gpuDeviceImportSharedBufferMemory(WGPUDevice self, const WGPUSharedBufferMemoryDescriptor* descriptor) {
    return wgpuDeviceImportSharedBufferMemory(self, descriptor);
}
EMSCRIPTEN_KEEPALIVE WGPUSharedTextureMemory gpuDeviceImportSharedTextureMemory(WGPUDevice self, const WGPUSharedTextureMemoryDescriptor* descriptor) {
    return wgpuDeviceImportSharedTextureMemory(self, descriptor);
}
EMSCRIPTEN_KEEPALIVE WGPUSharedFence gpuDeviceImportSharedFence(WGPUDevice self, const WGPUSharedFenceDescriptor* descriptor) {
...
EMSCRIPTEN_KEEPALIVE int gpuDeviceGetAHardwareBufferProperties(WGPUDevice self, void * handle, WGPUAHardwareBufferProperties* properties) {
    return wgpuDeviceGetAHardwareBufferProperties(self, handle, properties);
}
EMSCRIPTEN_KEEPALIVE int gpuDeviceGetLimits(WGPUDevice self, WGPUSupportedLimits* limits) {
...
EMSCRIPTEN_KEEPALIVE int gpuDeviceGetAdapterInfo(WGPUDevice self, WGPUAdapterInfo* adapterInfo) {
...
EMSCRIPTEN_KEEPALIVE void gpuDeviceInjectError(WGPUDevice self, int typ, WGPUStringView message) {
    return wgpuDeviceInjectError(self, typ, message);
}
EMSCRIPTEN_KEEPALIVE void gpuDeviceForceLoss(WGPUDevice self, int typ, WGPUStringView message) {
...
EMSCRIPTEN_KEEPALIVE void gpuDevicePopErrorScope(WGPUDevice self, void* oldCallback, void * userdata) {
...
EMSCRIPTEN_KEEPALIVE int gpuInstanceWaitAny(const WGPUInstanceWaitAnyArgs* args) {
...
EMSCRIPTEN_KEEPALIVE bool gpuInstanceHasWGSLLanguageFeature(WGPUInstance self, int feature) {
    return wgpuInstanceHasWGSLLanguageFeature(self, feature);
}
EMSCRIPTEN_KEEPALIVE size_t gpuInstanceEnumerateWGSLLanguageFeatures(WGPUInstance self, int* features) {
    return wgpuInstanceEnumerateWGSLLanguageFeatures(self, features);
}
EMSCRIPTEN_KEEPALIVE int gpuGetInstanceFeatures(WGPUInstanceFeatures* features) {
...
EMSCRIPTEN_KEEPALIVE void gpuQueueOnSubmittedWorkDone(WGPUQueue self, void* callback, void * userdata) {
...
EMSCRIPTEN_KEEPALIVE void gpuRenderPassEncoderPixelLocalStorageBarrier(WGPURenderPassEncoder self) {
...
EMSCRIPTEN_KEEPALIVE int gpuSurfaceGetCapabilities(WGPUSurface self, WGPUAdapter adapter, WGPUSurfaceCapabilities* capabilities) {
...
EMSCRIPTEN_KEEPALIVE WGPUTextureView gpuTextureCreateErrorView(WGPUTexture self, const WGPUTextureViewDescriptor* descriptor) {
